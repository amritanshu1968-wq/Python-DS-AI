...
class RegularStudent(Student):
    ...
    def get_attendance_requirement(self):
        return "Minimum 95% attendance is mandatory"
# Child class 2: Distance Learning 
class DistanceStudent(Student):
    def calculate_fees(self):
        return "Tuition: 10000"
    def get_attendance_requirement(self):
        return "Must be regular."
    
# Calling Driver code
Student_a = RegularStudent("Amritanshu Shukla", "REG2025-7")
Student_b = DistanceStudent("Ayush Singh", "DSI2026-7")
